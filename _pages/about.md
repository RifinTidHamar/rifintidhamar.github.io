...
My first step into game creation was when I was 12. It was honest, but somewhat misguided. I started learning Blender. Here are some of [my very earliest renders](https://imgur.com/gallery/early-blender-renders-v21uabQ). You see, I had zero idea what it meant to make a game, and for some reason I thought people made games completely inside of tools like Blender. Like I actually thought a game was exactly like a movie, and they just pre-rendered every possible thing a user might do for every possibility. Can you imagine the infinite amount of storage that would take? Eventually I figured out that's not how games work, but I still always loved Blender. 

While I didn't explicitly learn to make games with Blender, I did learn valuable concepts that you see popping up in tech art all the time: 3D models, vertices, UV coordinates, texture wrapping, normal maps, an introduction into shaders with Blender's node system, and I even learned how to properly problem solve: bash my head against the nearest wall until I no longer can remeber the problem. Blender helped me visualize what I would later code. 
